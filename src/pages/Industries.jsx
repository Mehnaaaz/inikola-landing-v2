      ...
      <section className="hero hero--inner">
        ...
        <div className="container hero__grid">
          <div className="hero__left" data-reveal>
            ...
            <h1 className="hero__title">Industries</h1>
            <p className="hero__subtitle">Solutions for real estate, hospitality, enterprises, and smart infrastructure.</p>
